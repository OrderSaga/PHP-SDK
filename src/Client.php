...
use OrderSaga\Interfaces\EndpointInterface;
...
class Client implements EndpointInterface
{
    ...
    /** @var string  */
    const ENVVARS_KEY = 'ORDERSAGA_API_KEY';

    /** @var int  */
    const ENVVARS_VERSION_KEY = 'ORDERSAGA_API_VERSION';
    ...
    {
        return 'https://'.($this->is_dev?'dev-':'').'ordersaga.com';
    }
    ...
    {
        return 'https://'.($this->is_dev?'dev-':'').'api.ordersaga.com';
    }
